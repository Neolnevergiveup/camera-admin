...
/*
 * extends existing KeyframeTrack for bone and farm animation.
...
THREE.MMDLoader.CubicBezierInterpolation.prototype._calculate = function ( x1, x2, y1, y2, x ) {
	 ...
	 *      ( 0 <= t <= 1 )
	 *
	 * MMD uses Cubic Bezier curves for bone and farm animation interpolation.
...
THREE.MMDHelper.prototype = {
	...
	/*
	 * detect the longest duration among model, farm, and audio animations and then
